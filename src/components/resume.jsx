...
export default function Resume() {
  return (
    ...
    <p id='resume-text'>November 2021 to November 2021</p>
    <p id='resume-text'>The chainlink fall hackathon was a web3/crypto dev event where participants had to use new technologies
to build dApps (decentralized autonomous applications). I built a NFT publishing platform inspired by
...
utm_source=copy&utm_medium=social&utm_campaign=university_social_sharing'>certificate link</a></p>
    ...
    <p id='resume-text'><b>M121: The MongoDB Aggregation Framework</b></p>
    <p id='resume-text'><a href='https://university.mongodb.com/course_completion/850b51a0-5bc3-4eb4-912b-ea6e39433cdb?
utm_source=copy&utm_medium=social&utm_campaign=university_social_sharing'>certificate link</a></p>

    <p id='resume-text'><b>M001: MongoDB Basics</b></p>
    <p id='resume-text'><a href='https://university.mongodb.com/course_completion/aa16fe03-3da8-4e0f-a60e-6971a84ef0d2?
utm_source=copy&utm_medium=social&utm_campaign=university_social_sharing'>certificate link</a></p>

    <p id='resume-text'><b>JavaScript Algorithms and Data Structures</b></p>
